...
static stageName as string = "自动化";
...
//非超频配方
    ...
    static shapelessRecipes as IIngredient[][IItemStack] = {
        <appliedenergistics2:part:100> : [<appliedenergistics2:part:80>],
        <appliedenergistics2:part:280> : [<appliedenergistics2:part:16>,<minecraft:redstone_torch>]
