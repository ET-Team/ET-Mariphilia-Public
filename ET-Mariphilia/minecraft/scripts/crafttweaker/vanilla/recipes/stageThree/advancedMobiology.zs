...
static stageName as string = "进阶怪物学";
...
//非超频配方
    ...
    static shapedRecipes as IIngredient[][][IItemStack] = {
        <woot:yahhammer> : [
            [<woot:stygianironingot>,<woot:stygianironingot>,<woot:stygianironingot>],
            [<woot:stygianironingot>,<ore:stickWood>,<woot:stygianironingot>],
