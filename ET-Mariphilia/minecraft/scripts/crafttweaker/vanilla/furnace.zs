...
static furnaceRecipes as IIngredient[IItemStack] = {
    ...
    <appliedenergistics2:smooth_sky_stone_block> : <appliedenergistics2:sky_stone_block>,
    <ore:ingotOsmium>.firstItem : <ore:dustOsmium>,
    <woot:stygianironingot> : <woot:stygianirondust>,
