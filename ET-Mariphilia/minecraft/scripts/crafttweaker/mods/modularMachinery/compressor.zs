...
static recipes as IItemStack[][int][IItemStack] = {
    <ore:plateBiopolymerMaterial>.firstItem*4 :{80 : [<item:minecraft:rotten_flesh>*64,<item:minecraft:bone>*64,<item:minecraft:carrot>*32,<item:minecraft:wheat>*32]},
    <ore:ingotCompressedAshMetal>.firstItem*4 :{80 : [<item:minecraft:iron_ingot>*16,<ore:ingotAshenMetal>.firstItem*16,<ore:ingotDawnstone>.firstItem*16]},
    ...
    <ore:ingotYellorium>.firstItem : {20 : [<ore:dustYellorium>.firstItem]}
};
